...
public final class MeditationHud {
    private static final String[] STAGES = {
            "hud.earth_online_xuanhuan.meditation.stage.breath",
            "hud.earth_online_xuanhuan.meditation.stage.gather",
            "hud.earth_online_xuanhuan.meditation.stage.circulate",
            "hud.earth_online_xuanhuan.meditation.stage.settle"
    };
    ...
    public static void render(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        Component remainingText = Component.translatable("hud.earth_online_xuanhuan.meditation.remaining", remainingSeconds);
        ...
        graphics.centeredText(font, fit(font, Component.translatable("hud.earth_online_xuanhuan.meditation.hint"), panelWidth - 18),
