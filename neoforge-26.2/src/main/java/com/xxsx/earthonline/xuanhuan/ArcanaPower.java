...
public final class ArcanaPower {
    ...
    public static final String CULTIVATION_XP = "earth_online_arcana.cultivation_xp";
    public static final String BIGU_XP = "earth_online_arcana.bigu_xp";
    public static final String BODY_TEMPERING_XP = "earth_online_arcana.body_tempering_xp";
    public static final String FETAL_BREATH_XP = "earth_online_arcana.fetal_breath_xp";
    public static final String QI_MEDITATION_COOLDOWN_UNTIL = "earth_online_arcana.qi_meditation_cooldown_until";
    public static final String XUANHUAN_SKILL_COOLDOWN_UNTIL = "earth_online_arcana.xuanhuan_skill_cooldown_until";
