...
public final class XuanhuanHandbookItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        lines.accept(Component.translatable("tooltip.earth_online_xuanhuan.handbook.use")
                .withStyle(ChatFormatting.GRAY));
        lines.accept(Component.translatable("tooltip.earth_online_xuanhuan.handbook.scope")
