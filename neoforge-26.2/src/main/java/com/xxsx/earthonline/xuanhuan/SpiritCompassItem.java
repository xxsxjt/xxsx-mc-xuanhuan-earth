...
public class SpiritCompassItem extends Item {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        if (!level.isClientSide()) {
            ...
            player.sendSystemMessage(Component.translatable(
                    "message.earth_online_xuanhuan.compass.reading",
                    Spirituality.gradeName(reading.value()),
                    reading.value()).withStyle(ChatFormatting.AQUA));
            player.sendSystemMessage(Component.translatable("message.earth_online_xuanhuan.compass.field",
                    reading.mainSource(),
            ...
            player.sendSystemMessage(Component.translatable("message.earth_online_xuanhuan.compass.hint")
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> lines, TooltipFlag flag) {
        lines.accept(Component.translatable("tooltip.earth_online_xuanhuan.spirit_compass").withStyle(ChatFormatting.GOLD));
        lines.accept(Component.translatable("tooltip.earth_online_xuanhuan.spirit_compass.use").withStyle(ChatFormatting.GRAY));
    }
}
