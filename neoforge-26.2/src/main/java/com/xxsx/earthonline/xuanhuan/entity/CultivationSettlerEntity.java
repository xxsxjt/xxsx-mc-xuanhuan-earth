...
public final class CultivationSettlerEntity extends AbstractVillager {
    ...
    protected void updateTrades(ServerLevel level) {
        ...
        switch (getRole()) {
            case WANDERING_MERCHANT -> {
                add(offers, Items.EMERALD, 2, new ItemStack(EarthOnlineXuanhuan.SPIRIT_GRASS.get(), 3), 12, 2);
                add(offers, Items.EMERALD, 3, new ItemStack(EarthOnlineXuanhuan.TALISMAN_PAPER.get(), 2), 10, 3);
                add(offers, Items.AMETHYST_SHARD, 4, new ItemStack(EarthOnlineXuanhuan.SPIRIT_CRYSTAL_SHARD.get()), 8, 4);
            }
            case SPIRIT_SPRING_KEEPER -> {
                add(offers, Items.EMERALD, 2, new ItemStack(EarthOnlineXuanhuan.SPIRIT_SPRING_BOTTLE.get(), 2), 12, 2);
                add(offers, Items.EMERALD, 4, new ItemStack(EarthOnlineXuanhuan.QI_RECOVERY_PILL.get()), 8, 5);
                add(offers, Items.GOLD_INGOT, 3, new ItemStack(EarthOnlineXuanhuan.SPIRIT_BEAST_SEAL.get()), 6, 6);
            }
            case SECT_STEWARD -> {
                add(offers, Items.EMERALD, 5, new ItemStack(EarthOnlineXuanhuan.BASIC_TALISMAN.get()), 8, 5);
                add(offers, Items.EMERALD, 8, new ItemStack(EarthOnlineXuanhuan.QI_GUIDING_MANUAL.get()), 4, 8);
                add(offers, Items.IRON_INGOT, 6, new ItemStack(EarthOnlineXuanhuan.SPIRIT_IRON_BLANK.get()), 8, 5);
            }
        }
    }
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
        CultivationSettlerEntity child = EarthOnlineXuanhuan.CULTIVATION_SETTLER.get()
    ...
    public enum Role {
        WANDERING_MERCHANT(0, "entity.earth_online_xuanhuan.cultivation_settler.wandering_merchant"),
        SPIRIT_SPRING_KEEPER(1, "entity.earth_online_xuanhuan.cultivation_settler.spirit_spring_keeper"),
        SECT_STEWARD(2, "entity.earth_online_xuanhuan.cultivation_settler.sect_steward");
