...
public class XuanhuanMachineJeiCategory implements IRecipeCategory<XuanhuanMachineBlock.Recipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.earth_online_xuanhuan.machine", Component.translatable(kind.displayNameKey()));
    }
    ...
    public void draw(XuanhuanMachineBlock.Recipe recipe, IRecipeSlotsView slots, GuiGraphicsExtractor g, double mouseX, double mouseY) {
        ...
        g.text(font, Component.translatable("jei.earth_online_xuanhuan.process." + kind.blockId()), 58, 29, 0xFFE8DFAF);
        g.text(font, ">", 78, 29, 0xFFE8DFAF);
        g.text(font, Component.translatable("jei.earth_online_xuanhuan.field", recipe.minField(),
